...
const FALLBACK_IMAGE = 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=1200&q=80'
  ...
  return (
    <article className="detail-page">
      <div className="detail-gallery">
        <img src={imgs[imgIdx]} alt={p.title} className="detail-hero-img" />
        {p.verified && (
      ...
      {imgs.length > 1 && (
        <div className="detail-thumbs">
          ...
          {extraCount > 0 && (
            <button type="button" className="detail-thumb detail-thumb-more" onClick={() => setImgIdx(5)}>
              +{extraCount}
            </button>
          )}
        </div>
